...
public class SQLWriter {
     ...
     * Maximum SQL length.
     */
    private int maxSQLLength = 1048576;
...
//        }
    ...
    private void executeSQL(String sql) throws SQLException {
        try {
            ...
            if (errorCode == 0x362 || errorCode == 0x218 || errorCode == 2603 || errorCode == 9731) {
    ...
    private void createTables() throws SQLException {
        ...
        for (String tbName : tbValues.keySet()) {
            ...
            sb.append("IF NOT EXISTS ").append(tbName).append(" USING demo.meters TAGS ").append(tagValues).append(" ");
        }

...
public class SubscribeDemo {
    ...
    private static final String DB_NAME = "topic_demo";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String jdbcUrl = Constant.localJdbcUrl_3_0;
            ...
            properties.setProperty(TMQConstants.BOOTSTRAP_SERVERS, "192.168.229.128:6030");
            properties.setProperty(TMQConstants.MSG_WITH_TABLE_NAME, "true");
            properties.setProperty(TMQConstants.ENABLE_AUTO_COMMIT, "true");
            properties.setProperty(TMQConstants.GROUP_ID, "test");
            properties.setProperty(TMQConstants.VALUE_DESERIALIZER,MetersDeserializer.class.getCanonicalName());
